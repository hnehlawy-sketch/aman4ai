...
@Component({
  ...
  template: `
    <div class="flex gap-3 sm:gap-4 text-start group animate-slide-up"
      ...
      <!-- AI Avatar -->
      <div class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center flex-shrink-0 shadow-sm mt-1">
      ...
      <div class="flex-1 min-w-0">
         ...
         @if (message().text) {
            <div 
              class="text-slate-800 dark:text-slate-100 prose prose-slate dark:prose-invert max-w-none break-words leading-relaxed text-[0.95rem] font-normal text-start" 
